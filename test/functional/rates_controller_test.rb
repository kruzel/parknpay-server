...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { currency: @rate.currency, end_time: @rate.end_time, rate: @rate.rate, start_time: @rate.start_time }
    end
  ...
  test "should update rate" do
    put :update, id: @rate, rate: { currency: @rate.currency, end_time: @rate.end_time, rate: @rate.rate, start_time: @rate.start_time }
    assert_redirected_to rate_path(assigns(:rate))
  end
